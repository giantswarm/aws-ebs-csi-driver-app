...
*/}}
{{- define "aws-ebs-csi-driver-app-bundle.name" -}}
...
*/}}
{{- define "aws-ebs-csi-driver-app-bundle.fullname" -}}
...
*/}}
{{- define "aws-ebs-csi-driver-app-bundle.chart" -}}
...
Common labels
*/}}
{{- define "aws-ebs-csi-driver-app-bundle.labels" -}}
app.kubernetes.io/name: {{ include "aws-ebs-csi-driver-app-bundle.name" . }}
helm.sh/chart: {{ include "aws-ebs-csi-driver-app-bundle.chart" . }}
...
*/}}
{{- define "aws-ebs-csi-driver-app-bundle.trustPolicyStatements" -}}
